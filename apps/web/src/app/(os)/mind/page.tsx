...
export default function MindCommandCentrePage() {
  return (
    <main className="hud-root w-full px-2 py-2 sm:px-4 sm:py-4">
      <header className="mb-6 flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="hud-title text-3xl font-bold md:text-4xl">Mind Command Centre</h1>
          <p className="mt-2 text-sm text-white/70">Cycle day and consistency overview.</p>
        </div>
        <Link href="/os/mind/settings" className="chrome-btn px-3 py-1.5 text-sm text-white">
          Mind Settings
        </Link>
      </header>
